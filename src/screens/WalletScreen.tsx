      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar">
        <div className="px-[22px] pt-[18px]">
          ...
          <div className="bg-gradient-to-br from-forest to-[#153D28] rounded-[20px] p-5 mb-4">
            ...
            <div className="font-mono text-xs text-white/40 mb-4">5xKj...Ab3mPqRst</div>
            <div className="grid grid-cols-2 gap-2.5 mb-4">
              <div className="bg-white/8 rounded-xl p-3">
                <div className="text-[10px] text-white/35 mb-1">USDC Balance</div>
                <div className="font-serif text-[22px] text-white">$2,840</div>
              </div>
              <div className="bg-white/8 rounded-xl p-3">
                <div className="text-[10px] text-white/35 mb-1">SOL Balance</div>
                <div className="font-serif text-[22px] text-white">4.21</div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-3.5 bg-mist border border-leaf/20 rounded-[14px] mb-4">
            <div>
              <div className="text-xs font-medium text-forest">CACAO-FLORES-Q4-25</div>
              <div className="text-[11px] text-stone">Settled Apr 10, 2026</div>
            </div>
            <div className="text-right">
              <div className="text-lg font-semibold text-moss">Rp 1,820,000</div>
              <button
                onClick={() => openSheet('claim')}
